...
Интерфейс продолжает визуальный язык SLOGI и поддерживает работу с коммерческой недвижимостью. Код и маркетинговые материалы референсного сайта не копировались; используются существующие SLOGI assets.
