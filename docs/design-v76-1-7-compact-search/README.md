...
- Девять пользовательских страниц проверены на `1440×900`, `768×1024`, `390×844`: `27/27 PASS`.
- Горизонтальный overflow: `0/27`.
- Console errors/warnings: `0/0`.
- Шапка: `76 px` desktop, `62 px` tablet/mobile.
- Body: `16 px`, `Ubuntu Sans`.
- Минимальная высота видимых `button/input/select/textarea`: `44 px` на всех трёх размерах.
- Mobile menu: открытие `aria-expanded=true`, пять видимых целей, первая ссылка получает фокус; `Escape` закрывает меню и возвращает фокус на trigger.
