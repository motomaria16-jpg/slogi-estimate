...
GitHub publication не изменяет production Supabase и не разрешает новый production E2E, Edge deployment, Auth/secrets, Vault или cron без отдельного подтверждения владельца.
